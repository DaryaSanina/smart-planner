...
for example in response:
    try:
        ...
        data.append((task, importance, time))  # Add the example to the list of examples to be saved
    except Exception as e:  # If the task is not in the specified format
        pass

dataframe = pd.DataFrame(data=data, columns=["Task", "Importance", "Time to complete (minutes)"])  # Create a Pandas dataframe with the generated examples
